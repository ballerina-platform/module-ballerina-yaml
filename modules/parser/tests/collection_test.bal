...
function collectionDataGen() returns map<[string|string[], event:Event[]]> {
    return {
        ...
        "block sequence with starting tag": [["- !tag", " -"], [{startType: event:SEQUENCE}, {startType: event:SEQUENCE, tag: "!tag"}]],
        "block sequence with complete node properties": [["- !tag &anchor", " -"], [{startType: event:SEQUENCE}, {startType: event:SEQUENCE, tag: "!tag", anchor: "anchor"}]],
